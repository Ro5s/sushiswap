...
describe("KashiSushiMaker", function () {
  ...
  beforeEach(async function () {
    ...
    const initData = defaultAbiCoder.encode(["address", "address", "address", "bytes"], [this.sushi.address, this.dai.address, this.oracle.address, this.oracle.getDataParameter()])
